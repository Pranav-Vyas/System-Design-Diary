...
/*
----------------------------- Note -----------------------------------
Here there are 2 problems in this code:
1. we are using aggregation and not composition
- strategy will exist without PaymentProcessor
- we should create this inside class

PaymentStrategy strategy = new CreditCardPayment();

2. client is concerned about creating strategy
- we can use strategy + factory for this
